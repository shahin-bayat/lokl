...
func TestDisplayLog(t *testing.T) {
	tests := []struct {
		...
		{"drops private mode csi ending in m", "\x1b[>4;2mtext", "text"},
		{"mixed kept and dropped in one line", "\x1b[31mred\x1b[2Jrest", "\x1b[31mredrest"},
		{"multibyte utf8 passthrough", "über 🚀 done", "über 🚀 done"},
